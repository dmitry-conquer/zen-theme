...
class Setup
{
  ...
  {
    add_action('after_setup_theme', [self::class, 'refister_menus']);
    ...
    add_action('login_headertitle', [self::class, 'custom_login_logo_url_title']);
  }

  public static function refister_menus()
  {
    register_nav_menus([
